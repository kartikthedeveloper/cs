      ...
      <main className="relative xl:container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { title: "Blockchain Tutorial", href: "/tutorials/blockchain", icon: "📖" },
              { title: "Blockchain Interview Questions", href: "/interview/blockchain", icon: "💼" },
              { title: "Blockchain Notes", href: "/notes/blockchain", icon: "📝" },
              { title: "Cryptocurrency MCQs", href: "/mcq/cryptocurrency", icon: "🪙" },
              { title: "Bitcoin MCQs", href: "/mcq/bitcoin", icon: "₿" },
              { title: "DeFi MCQs", href: "/mcq/defi", icon: "🏦" },
            ].map((item) => (
              <Link
                key={item.title}
                href={item.href}
        ...
        <section className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Explore our full collection of Blockchain tutorials, notes, and interview guides to
            accelerate your learning journey.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/tutorials/blockchain"
