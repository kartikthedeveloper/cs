      ...
      <main className="relative xl:container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { title: "Computer Fundamentals Tutorial", href: "/tutorials/computer-fundamentals", icon: "📖" },
              { title: "Basic Computer Interview Questions", href: "/interview/computer-fundamentals", icon: "💼" },
              { title: "Computer Fundamentals Notes", href: "/notes/computer-fundamentals", icon: "📝" },
              { title: "MS Office MCQs", href: "/mcq/ms-office", icon: "📋" },
              { title: "Digital Logic MCQs", href: "/mcq/digital-logic", icon: "⚡" },
        ...
        <section className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl md:text-3xl font-bold mb-3">
            Ready to Master Computer Fundamentals?
          </h2>
