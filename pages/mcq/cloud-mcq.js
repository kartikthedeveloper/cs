      ...
      <main className="relative xl:container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { title: "Cloud Tutorial", href: "/tutorials/cloud", icon: "📖" },
              { title: "Cloud Interview Questions", href: "/interview/cloud", icon: "💼" },
              { title: "Cloud Notes", href: "/notes/cloud", icon: "📝" },
              { title: "AWS MCQs", href: "/mcq/aws-mcq", icon: "☁️" },
              { title: "Azure MCQs", href: "/mcq/azure-mcq", icon: "🔷" },
              { title: "DevOps MCQs", href: "/mcq/devops-mcq", icon: "⚙️" },
            ].map((item) => (
              <Link
                key={item.title}
                href={item.href}
        ...
        <section className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Explore our full collection of Cloud tutorials, notes, and interview guides to
            accelerate your learning journey.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/tutorials/cloud"
