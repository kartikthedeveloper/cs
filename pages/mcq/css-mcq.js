      ...
      <main className="relative xl:container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { title: "CSS Tutorial", href: "/tutorials/css", icon: "📖" },
              { title: "CSS Interview Questions", href: "/interview/css", icon: "💼" },
              { title: "CSS Notes & Cheat Sheet", href: "/notes/css", icon: "📝" },
              { title: "HTML MCQs", href: "/mcq/html", icon: "📋" },
              { title: "JavaScript MCQs", href: "/mcq/javascript", icon: "⚡" },
              { title: "Responsive Design Guide", href: "/guides/responsive-design", icon: "📱" },
            ].map((item) => (
              <Link
                key={item.title}
                href={item.href}
