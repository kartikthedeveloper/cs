      ...
      <main className="relative xl:container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { title: "Python MCQs", href: "/mcq/python", icon: "🐍" },
              { title: "Data Science MCQs", href: "/mcq/data-science", icon: "📊" },
              { title: "Machine Learning MCQs", href: "/mcq/machine-learning", icon: "🤖" },
              { title: "Deep Learning Notes", href: "/notes/deep-learning", icon: "🧠" },
              { title: "NLP Tutorial", href: "/tutorials/nlp", icon: "💬" },
              { title: "AI Interview Questions", href: "/interview/ai", icon: "💼" },
            ].map((item) => (
              <Link
                key={item.title}
                href={item.href}
        ...
        <section className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Explore our full collection of AI tutorials, notes, and interview guides to
